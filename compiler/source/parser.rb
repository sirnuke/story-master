...
class Parser
  ...
  def write_lua(out)
    ...
    out.puts
    out.puts "-- Header information"
    out.puts "STORYMASTER_VERSION_MAJOR = #{Constants::VERSION_MAJOR}"
    out.puts "STORYMASTER_VERSION_MINOR = #{Constants::VERSION_MINOR}"
    out.puts "STORYMASTER_VERSION_PATCH = #{Constants::VERSION_PATCH}"
    out.puts "STORYMASTER_SOURCE_FILE = \"#{@position.filename}\""
    out.puts
